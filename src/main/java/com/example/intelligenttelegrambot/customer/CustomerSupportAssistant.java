...
import com.example.intelligenttelegrambot.infrastructure.LoggingAdvisor;
...
//				.defaultFunctions("getBookingDetails", "changeBooking", "cancelBooking") // FUNCTION CALLING
    ...
    public String chat(String chatId, String userMessageContent) {
        ...
        return this.chatClient.prompt().system(s -> s.param("current_date", LocalDate.now().toString())).user(userMessageContent).advisors(a -> a.param(CHAT_MEMORY_CONVERSATION_ID_KEY, chatId).param(CHAT_MEMORY_RETRIEVE_SIZE_KEY, 100)).call().content();
    }
}