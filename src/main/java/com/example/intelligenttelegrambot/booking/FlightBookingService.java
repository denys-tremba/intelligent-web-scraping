...
import com.example.intelligenttelegrambot.customer.Customer;
import com.example.intelligenttelegrambot.customer.CustomerSupportAssistant;
import com.example.intelligenttelegrambot.customer.PriorPromptProcessingEvent;
...
public class FlightBookingService {
    ...
    @EventListener
    public void on(PriorPromptProcessingEvent event) {
        logger.warn("State of db before processing: {}", getBookings());
    }
    ...
    public BookingTools.BookingDetails getBookingDetails(String bookingNumber, String firstName, String lastName) {
    ...
    private BookingTools.BookingDetails toBookingDetails(Booking booking){
        return new BookingTools.BookingDetails(
